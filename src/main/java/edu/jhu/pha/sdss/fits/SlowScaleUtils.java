...
public class SlowScaleUtils extends ScaleUtils {
    ...
    public static Scaler getScaler(Object data) {
        ...
        if (data instanceof byte[][]) {
            ...
            throw new UnsupportedOperationException(data.getClass().getName() + " is not supported");
        }
    ...
    public interface Scaler {
        short[] linearScaleToUShort(Object data, short[] result,
                                           int width, int height,
                                           double bZero, double bScale,
                                           double min, double max);

        short[] logScaleToUShort(Object data, short[] result,
                                        int width, int height,
                                        double bZero, double bScale,
                                        double min, double max);

        short[] sqrtScaleToUShort(Object data, short[] result,
                                         int width, int height,
                                         double bZero, double bScale,
                                         double min, double max);

        short[] squareScaleToUShort(Object data, short[] result,
                                           int width, int height,
                                           double bZero, double bScale,
                                           double min, double max);

        short[] histEQScaleToUShort(Object data, short[] result,
                                           int width, int height,
                                           double bZero, double bScale,
                                           double min, double max,
                                           Histogram hist);

        short[] asinhScaleToUShort(Object data, short[] result,
                                          int width, int height,
                                          double bZero, double bScale,
                                          double min, double max,
                                          double sigma);
        ...
        public short[] linearScaleToUShort(Object data, short[] result,
            ...
            for (int y = 0; y < height; ++y) {
                for (int x = 0; x < width; ++x) {
                    ...
                    result[bandedIndex + 2] =
                            (short) (Math.max(0.0,
                                  Math.min(offset + bScale * (double) vals[y][x], uBound)) * linearScaleFactor);
                }
            }
        ...
        public short[] squareScaleToUShort(Object data, short[] result,
            ...
            for (int y = 0; y < height; ++y) {
                for (int x = 0; x < width; ++x) {
                    ...
                    result[bandedIndex + 1] =
                    result[bandedIndex + 2] =
                            (short) (Math.pow(Math.max(0.0,
                                  Math.min(offset + bScale * (double) vals[y][x], uBound)), 2.0) * squareScaleFactor);
                }
            }
        ...
        public short[] asinhScaleToUShort(Object data, short[] result,
            ...
            for (int y = 0; y < height; ++y) {
                for (int x = 0; x < width; ++x) {
                    ...
                    result[bandedIndex + 1] =
                    result[bandedIndex + 2] =
                            (short) (arcsinh(Math.max(0.0,
                                  Math.min(offset + bScale * (double) vals[y][x], uBound)) / sigma) * asinhScaleFactor);
                }
            }
            ...
            for (int y = 0; y < height; ++y) {
                for (int x = 0; x < width; ++x) {
                    ...
                    result[bandedIndex + 2] =
                            val <= 0.0 ?
                                    (short) 0 :
                                    (short) (((Math.log(val * linearScaleFactor)) / log10) * logScaleFactor);
                }
            }
        ...
        public short[] sqrtScaleToUShort(Object data, short[] result,
            ...
            for (int y = 0; y < height; ++y) {
                for (int x = 0; x < width; ++x) {
                    ...
                    result[bandedIndex + 1] =
                    result[bandedIndex + 2] =
                        (short) (Math.sqrt(Math.max(0.0,
                              Math.min(offset + bScale * (double) vals[y][x], uBound))) * sqrtScaleFactor);
                }
            }
    ...
    public static class DoubleScaler implements Scaler {
        public short[] linearScaleToUShort(Object data, short[] result,
            ...
            for (int y = 0; y < height; ++y) {
                for (int x = 0; x < width; ++x) {
                    ...
                    result[bandedIndex + 2] =
                            (short) (Math.max(0.0,
                                  Math.min(offset + bScale * vals[y][x], uBound)) * linearScaleFactor);
                }
            }
        ...
        public short[] sqrtScaleToUShort(Object data, short[] result,
            ...
            for (int y = 0; y < height; ++y) {
                for (int x = 0; x < width; ++x) {
                    ...
                    result[bandedIndex + 2] =
                        (short) (Math.sqrt(Math.max(0.0,
                              Math.min(offset + bScale * vals[y][x], uBound))) * sqrtScaleFactor);
                }
            }
        ...
        public short[] squareScaleToUShort(Object data, short[] result,
            ...
            for (int y = 0; y < height; ++y) {
                for (int x = 0; x < width; ++x) {
                    ...
                    result[bandedIndex + 2] =
                        (short) (Math.pow(Math.max(0.0,
                              Math.min(offset + bScale * vals[y][x], uBound)), 2.0) * squareScaleFactor);
                }
            }
        ...
        public short[] histEQScaleToUShort(Object data, short[] result,
            ...
            for (int y = 0; y < height; ++y) {
                for (int x = 0; x < width; ++x) {
                    double val = Math.max(0.0,
                            Math.min(offset + bScale * vals[y][x],
                                    uBound));
                    int bandedIndex = (y * width + x) * 3;
                    result[bandedIndex] =
                    result[bandedIndex + 1] =
        ...
        public short[] asinhScaleToUShort(Object data, short[] result,
            ...
            for (int y = 0; y < height; ++y) {
                for (int x = 0; x < width; ++x) {
                    ...
                    result[bandedIndex + 2] =
                        (short) (arcsinh(Math.max(0.0,
                              Math.min(offset + bScale * vals[y][x], uBound)) / sigma) * asinhScaleFactor);
                }
            }
